...
const JobProcess = () => {
    const processes = [
        {
            ...
            description: " Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ullam, repellendus omnis, nobis sit consequatur quisquam perspiciatis minima suscipit officiis atque fugit vitae inventore rerum ad? Iusto odio qui nihil amet!",
    ...
    return (
        <div className='w-full h-screen text-black flex flex-col     items-center justify-center gap-y-40 px-10'>
            <h1 className='text-4xl font-medium'> Our Job Process</h1>
